...
export default function GeneratorPage() {
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4">Error Loading Generators</h1>
            ...
            <div className="max-w-[1320px] mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mt-16 bg-white rounded-lg shadow-lg p-8">
                        <h2 className="text-2xl font-bold text-gray-800 mb-6">About Our Generators</h2>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-800 mb-4">Generator Types</h3>
                                <div className="space-y-3 text-gray-700">
                                    <p><strong>VISA Generators:</strong> Italian engineering excellence with reliable power output and efficient operation.</p>
                                    <p><strong>Teksan Generators:</strong> Turkish premium generator series with advanced technology and robust construction.</p>
                                    <p><strong>VOLCANO Generators:</strong> Heavy-duty generators designed for continuous operation and high reliability.</p>
                                    <p><strong>Powerlink Generators:</strong> UK engineered generators with modern control systems and fuel-efficient operation.</p>
                                </div>
                            </div>
                            <div>
