...
export default function LGLiftPage() {
  ...
  useEffect(() => {
    // Filter LG lifts
    const lgLifts = allProducts.filter((lift) => lift.brand === "LG");
    setLifts(lgLifts);
    setIsLoading(false);
  }, []);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading LG lifts...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative h-96 flex items-center justify-center  text-white overflow-hidden">
        ...
        <div className="relative max-w-[1320px] mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-5xl font-bold mb-4">LG - Sino Korea</h1>
            <p className="text-xl max-w-3xl mx-auto">
              Korean innovation meets Chinese manufacturing excellence. LG SIGMA
              series delivers advanced elevator technology with regenerative
              drives and premium build quality for modern buildings.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-4">
                  LG - Korean Technology Excellence
                </h2>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  LG brings decades of Korean technological innovation to the
                  elevator industry. Our SIGMA series combines permanent magnet
                  gearless motors with VVVF regenerative drives for exceptional
                  energy efficiency. From passenger elevators to specialized
                  hospital lifts, LG delivers reliability that meets
                  international KS standards and ISO certifications.
                </p>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="bg-emerald-50 p-4 rounded">
                    ...
                    <p className="text-emerald-600">450kg - 2500kg</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded">
                    <h4 className="font-semibold text-green-800 mb-2">
                      Speed Range
                    </h4>
                    <p className="text-green-600">1.0 - 6.0 m/s</p>
                  </div>
                  <div className="bg-purple-50 p-4 rounded">
                    <h4 className="font-semibold text-purple-800 mb-2">
                      Floor Range
                    </h4>
                    <p className="text-purple-600">2 - 50 Floors</p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded">
                    <h4 className="font-semibold text-orange-800 mb-2">
                      Standards
                    </h4>
                    <p className="text-orange-600">Korean KS, ISO 14798</p>
                  </div>
                </div>
              </div>
              <div>
            ...
            {lifts.map((lift) => (
              ...
              >
                <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full">
                  <div className="h-48 bg-gradient-to-r from-emerald-500 to-emerald-700 relative overflow-hidden">
                  ...
                  <div className="p-6 flex flex-col h-[calc(100%-12rem)]">
                    <div className="bg-emerald-500 text-white text-xs font-bold px-2 py-1 rounded mb-3 inline-block w-fit">
                      LG
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Advanced SIGMA series with permanent magnet gearless motors
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  VVVF regenerative drive system that feeds energy back to
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Specialized hospital lifts with stainless steel interiors and
                  UPS integration
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Certified to Korean KS standards with international safety
                  compliance
                </p>
              </div>
            </div>
