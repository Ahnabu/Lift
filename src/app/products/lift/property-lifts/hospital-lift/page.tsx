...
export default function HospitalLiftPage() {
    ...
    useEffect(() => {
        const fetchLifts = async () => {
            try {
                setIsLoading(true);
                const hospitalLifts = await LiftService.getHospitalLifts();
                setLifts(hospitalLifts);
            } catch (err) {
                console.error('Error fetching hospital lifts:', err);
                setError('Failed to load hospital lifts');
            } finally {
                setIsLoading(false);
            }
        };
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Loading hospital lifts...</p>
                </div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4">Error Loading Hospital Lifts</h1>
