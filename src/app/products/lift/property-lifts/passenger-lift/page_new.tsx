            ...
            <div className="relative h-96 bg-gradient-to-r from-orange-400 to-orange-600 overflow-hidden">
                ...
                <div className="relative max-w-[1320px] mx-auto px-4 h-full flex items-center">
                    <div className="max-w-6xl mx-auto text-white">
                        <h1 className="text-5xl font-bold mb-4">Passenger Lifts</h1>
                        <p className="text-xl text-orange-100 max-w-2xl">
                            High-quality passenger elevators designed for residential and commercial buildings
                            with advanced safety features and smooth operation.
                        </p>
                    </div>
                </div>
            </div>
