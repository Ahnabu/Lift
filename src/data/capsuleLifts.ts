...
export const capsuleLiftData: CapsuleLift[] = [
  {
    ...
    observationPlane: 'Facade semi-circular ground observation (Observation angle 180°)',
    externalDecorationPlate: 'Coated steel plate, metallic paint (Drawing color No: Z-8-01108)',
    externalDecorationLighting: 'UP & down strip sculpting slim transparent lighting',
    carWall: 'Glass, hairline stainless steel, mirror stainless steel',
    carDoorType: 'Standard door (center open), Glass door ZP40-155A (center open)',
