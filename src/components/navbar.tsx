              ...
              <Sheet open={isNavOpen} onOpenChange={setIsNavOpen}>
                <SheetTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-white hover:text-primary hover:bg-gray-700 p-2"
                  >
                ...
                <SheetContent
                  side="left"
                  className="w-[300px] sm:w-[400px] bg-gray-800 text-white border-gray-700"
                >
                  <VisuallyHidden>
                ...
                <Sheet open={isContactOpen} onOpenChange={setIsContactOpen}>
                  <SheetTrigger asChild>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-white hover:text-primary hover:bg-gray-700 p-3"
                    >
        ...
        <>
          <button
            ...
            className={cn(
              ...
              isActiveRoute ? "text-primary" : "text-white hover:text-primary",
